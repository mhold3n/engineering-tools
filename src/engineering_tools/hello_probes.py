...
COMPONENT_PROBES = {
    ...
    "erpnext-hello": make_path_probe(
        "erpnext",
        "ERPNext",
        ("erpnext/__init__.py", "erpnext/hooks.py"),
        "ERPNext upstream",
    ),
    "erpnext-manufacturing-hello": make_path_probe(
        "erpnext-manufacturing",
        "ERPNext Manufacturing",
        ("erpnext/__init__.py", "erpnext/hooks.py"),
        "ERPNext Manufacturing upstream",
    ),
    "frepple-hello": make_binary_probe('frepple', 'frePPLe', ('frepple', 'frepplectl', 'frepple-server'), "frePPLe upstream"),
